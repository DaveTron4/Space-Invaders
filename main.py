...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, bullet_group):
        ...
        super().__init__()
        self.image = pygame.image.load("assets/space_ship_inkscape.svg")
...
class Alien(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, velocity, bullet_group):
        ...
        # List of alien images
        self.images = [
            pygame.image.load("assets/alien_inkscape.svg"),
            pygame.image.load("assets/alien_inkscape2.svg"),
            pygame.image.load("assets/alien_inkscape3.svg"),
            pygame.image.load("assets/alien_inkscape4.svg"),
        ]

        self.image_index = 0  # Index to track current image
        self.image_timer = 0  # Timer to control image change
        self.image_change_interval = 60  # Interval in frames to change image (adjust as needed)
    ...
    def update(self):
        ...
        # Update image timer
        self.image_timer += 1
        if self.image_timer >= self.image_change_interval:
            self.image_timer = 0
            self.change_image()
    ...
    def change_image(self):
        ...
        self.image_index = (self.image_index + 1) % len(self.images)  # Cycle through images
        self.image = self.images[self.image_index]
...
ship_svgs = ["assets/space_ship_inkscape.svg", "assets/space_ship_inkscape2.svg", "assets/space_ship_inkscape3.svg", "assets/space_ship_inkscape4.svg"]

#The main game loop
running = True
original_color = my_player.image  # Store the original image
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_SPACE:
                my_player.fire()
                my_player.image = pygame.image.load(random.choice(ship_svgs))
